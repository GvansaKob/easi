...
onMounted(async () => {
  const categorie = encodeURIComponent('Transport');
...
<template>
  <div class="bg-white min-h-screen flex flex-col">
    ...
    <div class="bg-violet text-white text-center py-6">
      <h1 class="text-2xl font-titre font-bold">Les aides transport</h1>
    </div>

    <div class="px-4 pt-3 pb-5 text-sm text-noir font-textse">
      Aides &gt; <span class="font-bold">Aides transport</span>
    </div>
